          ...
          >
            ...
            <div className="flex justify-center gap-4 mt-6">
              <motion.button
                ...
                className="px-6 py-3 bg-blue-600 rounded-full hover:bg-blue-700 text-primary font-semibold"
                onClick={startCamera}
              >
                Start Camera
              </motion.button>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                // Change: Using text-primary for button text
                className="px-6 py-3 bg-red-600 rounded-full hover:bg-red-700 text-primary font-semibold"
                onClick={stopCamera}
              >
                Stop Camera
              </motion.button>
        ...
        <div className="w-full md:w-1/3 p-8 flex flex-col justify-center items-center">
          ...
          >
            ...
            <p className="text-xl mb-4 text-primary">
              Your emotion is{" "}
              <span 
                className="mx-2 inline-block px-4 py-2 bg-white text-indigo-600 font-bold rounded-md border-2 border-indigo-400 hover:text-accent-hover" 
                // Change: Added hover state to use accent-hover for the emotion text span
              >
                {emotion}
              </span>
            </p>
