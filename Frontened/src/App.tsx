...
function App() {
  ...
  const { isSignedIn, openSignIn } = useClerk();  // Get Clerk auth state and functions

  // When clicking "Get Recommendations", trigger sign in if not authenticated.
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="mt-8 px-8 py-3 bg-orange-500 text-white rounded-full font-medium
                         hover:bg-orange-600 transition-colors duration-300"
              onClick={handleGetRecommendations}  // Use the handler to check auth status
            >
              Get Recommendations
            </motion.button>
          </motion.div>
